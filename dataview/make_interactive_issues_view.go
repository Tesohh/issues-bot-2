...
func MakeInteractiveIssuesView(issues []db.Issue, state *db.ProjectViewState, dummy bool) []dg.MessageComponent {
	...
	queryButtons := dg.ActionsRow{
		Components: []dg.MessageComponent{
			...
			dg.Button{Label: "Filter people... (WIP)", Style: dg.SecondaryButton, CustomID: fmt.Sprintf("issues-filter-people:%s", msgID), Disabled: dummy},
			dg.Button{Label: "Filter data... (WIP)", Style: dg.SecondaryButton, CustomID: fmt.Sprintf("issues-filter-data:%s", msgID), Disabled: dummy},
		},
	}
